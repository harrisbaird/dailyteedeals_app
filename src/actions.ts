...
export const fetchArtist = slug => requestAction('artists/' + slug, ARTIST, {})
export const fetchCategory = slug =>
  requestAction('categories/' + slug, CATEGORY, {})
export const fetchCategories = () =>
  requestAction('categories', CATEGORIES, {})
export const fetchDeals = () => requestAction('deals', DEALS, {})
export const fetchSites = () => requestAction('sites', SITES, {})
export const fetchSearch = params => requestAction('search', SEARCH, params)

export const invalidateArtist = () => action(ARTIST_INVALIDATE)
